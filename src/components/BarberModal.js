...
export default ({show, setShow, user, service}) => {
  ...
  const handleFinishClick = async () => {
    if(user.id && service !== null && selectedYear > 0 
      && selectedMonth > 0 && selectedHour !== null){
        let res = await Api.setAppointment(
          user.id, service, selectedYear, selectedMonth, selectedDay, selectedHour);
      ...
      alert("Please select a date and time to finish");
    }
  }
      ...
      <ModalArea>
        <ModalBody>
          ...
          <FinishButton onPress={handleFinishClick}>
            <FinishButtonText>Finish scheduling</FinishButtonText>
          </FinishButton>
